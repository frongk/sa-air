...
DATASET_FILE_ID = 'data/energy/energy_aggs/agg_agg_may_2017.csv'
...
MAPPING_FILE_ID = f'{COORD_MAPPING_PATH}/energy_map_sa_100.pkl'
...
data_locations = data_set[(data_set[DATE_NAME]==DATE_FILTER) &
...
for idx, point in tqdm(grid.iterrows(), desc='connecting points'):
    coord1 = tuple(point[[GRID_LAT_NAME, GRID_LON_NAME]])
